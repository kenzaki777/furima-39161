class User < ApplicationRecord
  ...
  devise :database_authenticatable, :registerable,
        ...
        validates :second_name_kana, presence:true, format: {with:/\A[ァ-ヶー]+\z/,message: "カタカナのみ使用できます" }
        validates :first_name_kana, presence:true, format: {with:/\A[ァ-ヶー]+\z/, message: "カタカナのみ使用できます" }
