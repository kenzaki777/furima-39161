...
RSpec.describe User, type: :model do
  ...
  describe 'ユーザー新規登録' do
    ...
    it 'passwordが数字だけだと登録できない' do
      ...
      @user.valid?
      expect(@user.errors.full_messages).to include('Password 半角英数字のみ使用できます')
    end
    ...
    it 'first_nameが半角では登録できない' do
      ...
      @user.valid?
      expect(@user.errors.full_messages).to include("First name 漢字・ひらがな・カタカナのみ使用できます")
    end
    ...
    it 'second_nameが半角では登録できない' do
      ...
      @user.valid?
      expect(@user.errors.full_messages).to include("Second name 漢字・ひらがな・カタカナのみ使用できます")
    end
    ...
    it 'second_name_kanaが半角では登録できない' do
      ...
      @user.valid?
      expect(@user.errors.full_messages).to include("Second name kana カタカナのみ使用できます")
    end
